...
r = requests.get('https://api.proxyscrape.com/v2/?request=getproxies&protocol=socks5&timeout=05&country=india&ssl=all&anonymity=all&simplified=true').text
res = r.partition('\n')[0]
...
async def helpstr(message: types.Message):
    ...
    await message.reply(
        "Hello how to use <code>/chk cc/mm/yy/cvv</code>\nREPO <a href='https://github.com/Srfxd48/Mrbannker'>Here</a>"
    )
